...
class AzureSpeechProvider:
    ...
    async def assess(
        ...
        try:
            ...
            words = [self._word(item) for item in best.get("Words") or []]
            ...
            raise ProviderError(
                ...
                message="The speech provider is unavailable or returned an invalid response",
                status_code=502,
                retryable=True,
            ) from exc
    ...
    def _speech_url(self) -> str:
        return (
            f"{self._settings.azure_speech_base_url.rstrip('/')}"
