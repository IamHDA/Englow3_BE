 ...
 */
class PipelineMediaTest {

    @Test
    void keepsThePathOfAUrlAsTheKey() {
        assertThat(PipelineMedia.objectKey("http://localhost:9000/audio/flashcards/vocab_8e75a7579f0c2530_us.mp3"))
    ...
    void givesTheSameKeyWhereverTheFileWasServedFrom() {
        assertThat(PipelineMedia.objectKey("https://cdn.example.com/audio/shadowing/shadow_001.mp3"))
                .isEqualTo(PipelineMedia.objectKey("http://localhost:9000/audio/shadowing/shadow_001.mp3"));
    }

    @Test
    void leavesSomethingThatIsAlreadyAKeyAlone() {
        assertThat(PipelineMedia.objectKey("audio/flashcards/a.mp3")).isEqualTo("audio/flashcards/a.mp3");
        assertThat(PipelineMedia.objectKey("/audio/flashcards/a.mp3")).isEqualTo("audio/flashcards/a.mp3");
    }
    ...
    void hasNoKeyForNoAudio() {
        assertThat(PipelineMedia.objectKey(null)).isNull();
        assertThat(PipelineMedia.objectKey("   ")).isNull();
        assertThat(PipelineMedia.objectKey("http://localhost:9000/")).isNull();
    }
}
