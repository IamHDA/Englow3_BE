...
class AiEvaluationWorkerTest {
    ...
    void summarizesRepeatedRunsWithVarianceAgreementLatencyTokensAndCost() {
        ...
        List<EvaluationCaseResult> results = List.of(
                new EvaluationCaseResult(true, BigDecimal.ONE, false, new BigDecimal("80"), new BigDecimal("5"), 100,
                        10, 5, new BigDecimal("0.001"), "a".repeat(64), noViolations),
                new EvaluationCaseResult(true, new BigDecimal("0.5"), false, new BigDecimal("90"), new BigDecimal("5"),
                        300, 12, 7, new BigDecimal("0.002"), "b".repeat(64), noViolations));
