...
import com.englow3.learning.dto.command.SubmitQuizAttemptCommand.SubmittedAnswer;
import com.englow3.learning.dto.result.QuizAttemptResult;
import com.englow3.learning.dto.result.QuizAttemptResult.QuestionReviewResult;
import com.englow3.learning.dto.result.QuizPaperResult;
import com.englow3.learning.dto.result.QuizQuestionResult;
import com.englow3.learning.dto.result.QuizQuestionResult.OptionResult;
...
import com.englow3.learning.repository.QuizQuestionPairRepository;
import com.englow3.learning.repository.QuizQuestionRepository;
...
public class QuizService {
    ...
    private record QuestionContent(Map<UUID, List<QuizQuestionOption>> options,
        ...
        String userAnswerText(QuizQuestion question, String response) {
            if (question.getQuestionType() != com.englow3.learning.entity.QuizQuestionType.MULTIPLE_CHOICE) {
                return response;
            }
