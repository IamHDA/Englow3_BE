...
public record OnboardingStateResponse(
        OnboardingStep step,
        boolean completed,
        Set<Integer> learningPurposeIds,
        boolean certificateLearner,
        String targetCertificateType,
        CertificateLevel currentLevel,
    ...
    public static OnboardingStateResponse of(User user, LearnerProfile profile, boolean certificateLearner) {
        return new OnboardingStateResponse(
                ...
                new TreeSet<>(user.getLearningPurposeIds()),
                certificateLearner,
