...
public record SpeechProperties(@DefaultValue("false") boolean enabled,
        @DefaultValue("https://example.cognitiveservices.azure.com") String baseUrl, @DefaultValue("") String apiKey,
        @DefaultValue("en-US") String locale, @DefaultValue("45s") Duration readTimeout,
