...
Đặc tả gốc: [`AGENT_WORK_ORDER_ENGLISH_DATA_PIPELINE.md`](AGENT_WORK_ORDER_ENGLISH_DATA_PIPELINE.md).
Các quyết định hiện hành được ghi tại [`decisions.md`](decisions.md).
