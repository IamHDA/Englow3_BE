...
DOUBLE_QUESTIONS = [
 ...
 ("What has Mr Wierzbicki overlooked?", Q.RC_INFERENCE, "rc_inference", 0.65, 2,
  "Date: 26 May",
  [("He is close to the application deadline", True,
    "Email đề ngày 26 tháng Năm, mà đơn đóng ngày 31 tháng Năm và không nhận muộn."),
   ("He needs approval from his line manager first", False,
    "Thông báo nói rõ nộp thẳng cho Payroll."),
   ("His bicycle alone exceeds the maximum value", False,
    "£1,280 vẫn dưới mức tối đa £1,500."),
   ("He cannot repay the amount over eighteen months", False,
    "Thông báo cho phép cả mười hai và mười tám tháng.")]),
